...
<div class="container" style="margin-top: 1%;">
    ...
    <div class="row" style="margin-top: 3%;">
        <div class="col-lg-4">
            <div class=" p-4 border text-center bor-ten shadow bg-primary">
                <img src="../images/email.svg" alt="email" class="p-2" style="width: 88px;">
                
                <br><br>
                <a href="mail.php" class="btn btn-outline-light">Internal mail</a>
            </div>
        </div>
        <div class="col-lg-4">
            <div class=" p-4 border text-center bor-ten shadow bg-danger">
        ...
        <div class="col-lg-4">
            <div class=" p-4 border text-center bor-ten shadow bg-info">
