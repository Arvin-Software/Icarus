        ...
        <table class="table table-borderless border">
            ...
            <?php
                ...
                foreach($ret as $p){
                    ...
                    if($p['stat'] == "Invoice"){
                        echo '<td class=""><a href="edit.php?id=' . $p['entryid'] . '&stat=' . $p['stat'] . '&fin=' . $p['fin_year_id'] . '" style="" class="btn btn-outline-dark rounded-circle"><i class="far fa-edit"></i></a>&nbsp;&nbsp;<a href="view.php?id=' . $p['entryid'] . '&stat=' . $p['stat'] . '&year=' . $_GET['year'] . '" style="" class="btn btn-outline-dark rounded-circle"><i class="far fa-eye"></i></a>&nbsp;&nbsp;<a href="transport.php?id=' . $p['entryid'] . '&inv=' . $p['invno'] . '&year=' . $_GET['year'] . '" style="" class="btn btn-outline-dark rounded-circle"><i class="fas fa-truck-moving"></i></a></td>';
                    }else{
                    echo '<td class=""><a href="edit.php?id=' . $p['entryid'] . '&stat=' . $p['stat'] . '&fin=' . $p['fin_year_id'] . '" style="" class="btn btn-outline-dark rounded-circle"><i class="far fa-edit"></i></a>&nbsp;&nbsp;<a href="view.php?id=' . $p['entryid'] . '&stat=' . $p['stat'] . '&year=' . $_GET['year'] . '" style="" class="btn btn-outline-dark rounded-circle"><i class="far fa-eye"></i></a>&nbsp;&nbsp;<a href="transport.php?id=' . $p['entryid'] . '&inv=' . $p['invno'] . '&year=' . $_GET['year'] . '" style="" class="btn btn-outline-dark rounded-circle"><i class="fas fa-truck-moving"></i></a></td>';
                    }
                    echo '</tr>';
