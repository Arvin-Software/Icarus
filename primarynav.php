  ...
  <div class="collapse navbar-collapse" id="collapsibleNavbar" style="padding-left: 2%; ">
    ...
    echo '<li class="nav-item">';
      ...
      if($_SESSION['typ'] == "1"){
        ...
        if($mainnav=="access"){
          echo '<a class="btn text-left btn-primary  bor-none" href="accontrol.php"><img src="/icarus/images/customer.svg" class="" style="width: 28px;">&nbsp;&nbsp;Access control</a>';
        }else{
          echo '<a class="btn text-left text-dark bor-none" href="accontrol.php"><img src="/icarus/images/customer.svg" class="" style="width: 28px;">&nbsp;&nbsp;Access control</a>';
        }
        echo '</li>';
      }
      echo '<li class="nav-item">';
